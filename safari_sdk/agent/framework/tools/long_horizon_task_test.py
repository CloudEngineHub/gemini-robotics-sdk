...
from safari_sdk.agent.framework.tools import long_horizon_task
from safari_sdk.agent.framework.tools import tool


class LongHorizonTaskToolTest(unittest.IsolatedAsyncioTestCase):
  ...
  async def test_instantiation_test(self):
    ...
    long_horizon_task.LongHorizonTaskTool(
        bus=self.bus,
