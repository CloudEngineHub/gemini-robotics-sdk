...
HEAD_LEFT_ENDPOINT = _Endpoints.HEAD_LEFT_CAMERA_STREAM.value.path
HEAD_RIGHT_ENDPOINT = _Endpoints.HEAD_RIGHT_CAMERA_STREAM.value.path
...
CAGE_MULTICAMERA_ENDPOINT = _Endpoints.CAGE_MULTICAMERA_STREAM.value.path
...
class Fr3DuoEmbodiment(embodiment.Embodiment):
